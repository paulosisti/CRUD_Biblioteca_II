...
// cadastroLivros.buscarPorStatus('Disponível',function (err, res){
...
// cadastroFuncionarios.login(1, {usuario:"José", senha:"125"}, function (err,res){
...
// cadastroAutores.atualizar("Paola", "Brasil",16,function (err, res){
...
// cadastroAutores.deletar(16, function (err, res){
...
// cadastroEmprestimo.inserir(8, 6,function (err, res){
